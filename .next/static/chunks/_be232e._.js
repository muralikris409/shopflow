(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_be232e._.js", {
...
function UserCartService() {
    ...
    this.addItemToCart = async function(userId, productId, quantity = 1) {
        try {
            console.log(token);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post('/user/cart/addItemToCart', {
                params: {
                    userId,
                    productId,
                    quantity
    ...
    this.deleteFromCart = async function(userId, productId) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post('/user/cart/deleteFromCart', null, {
                params: {
                    userId,
                    productId
                },
    ...
    this.updateCartCount = async function(userId, productId, operation) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post('/user/cart/cartCount', null, {
                params: {
                    userId,
                    productId,
                    operation
...
_s(ProductView, "wwozkPYuXjHFfszlt2mcSB3o0is=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"]
    ];
});
...
//# sourceMappingURL=_be232e._.js.map