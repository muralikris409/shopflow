...
"[project]/src/app/user/profile/address/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$UserService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/service/UserService.js [app-ssr] (ecmascript)"); // Adjust the path as needed
...
const AddressManagement = ()=>{
    ...
    const handleMakePrimary = async (addressId)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$UserService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeAddressPrimary"])(token, userId, addressId);
            if (result?.status === "success") {
                loadAddresses();
            } else {
    ...
    const handleDeleteAddress = async (addressId)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$UserService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeAddress"])(token, userId, addressId);
            if (result?.status === "success") {
                loadAddresses();
            } else {
    ...
    const handleSaveEditedAddress = async ()=>{
        if (!validateForm()) return;
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$UserService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateAddress"])(token, userId, editAddressId, newAddress);
            if (result?.status === "success") {
                loadAddresses();
                setShowForm(false);
...
"[project]/src/app/user/profile/address/page.js [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_app_23132c._.js.map