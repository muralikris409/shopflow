...
const OrderSummary = ({ title, steps, userId, orders, shippingMethods, totalBill, existingAddresses = [] })=>{
    ...
    const handlePayment = async ()=>{
        ...
        setError(null);
        try {
            const { razorpayOrder } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$OrderService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkOutOrder"])(orders?.orders?.order?.id || orders?.orders.id);
            const options = {
                key: 'rzp_test_nTbKdtgjeOQLhc',
                amount: Math.ceil(totalBill * 100),
                currency: razorpayOrder?.currency,
                ...
                handler: async function(response) {
                    ...
                    if (verificationResult.success) {
                        ...
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$OrderService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["failedVerify"])(orders?.orders?.order?.id || orders?.orders.id);
                        setError('Payment verification failed. Please try again.');
                    }
                },
                prefill: {
...
//# sourceMappingURL=src_app_eb509c._.js.map