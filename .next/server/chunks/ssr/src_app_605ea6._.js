...
const ProductView = ({ product = {} })=>{
    ...
    async function handleAddorRemoveFromWishlist() {
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$WishListService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addOrRemoveProductFromWishlist"])(isLoggedIn.id, product.id, token);
            console.log(response);
...
//# sourceMappingURL=src_app_605ea6._.js.map