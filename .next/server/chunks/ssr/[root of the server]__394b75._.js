...
const AddressBook = ({ userId })=>{
    ...
    const handleSubmit = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/user/addAddress', {
                ...formData,
                userId
            });
            setShowForm(false);
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$UserService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchUserAddresses"])(userId);
            setAddresses(result);
        } catch (error) {
    ...
    const handleMakePrimary = async (addressId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/user/makePrimaryAddress', {
                userId,
                addressId
            });
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$service$2f$UserService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchUserAddresses"])(userId);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__394b75._.js.map