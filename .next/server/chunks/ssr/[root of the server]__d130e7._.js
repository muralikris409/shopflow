...
function UserCartService() {
    ...
    this.migrateCart = async function(userId) {
        ...
        if (guestCart.length > 0) {
            for (const item of guestCart){
                await this.addItemToCart(userId, item.id, item.quantity);
            }
            this.clearCart();
        }
    };
    this.addItemToCart = async function(userId, productId, quantity = 1) {
        try {
            console.log(token);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post('/user/cart/addItemToCart', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["headers"], {
                params: {
                    userId,
                    productId,
                    quantity
    ...
    this.deleteFromCart = async function(userId, productId) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post('/user/cart/deleteFromCart', null, {
                params: {
                    userId,
                    productId
                }
    ...
    this.updateCartCount = async function(userId, productId, operation) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post('/user/cart/cartCount', null, {
                params: {
                    userId,
                    productId,
                    operation
...
const Cart = ({ isLoggedIn, userId })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadCart = async ()=>{
            if (isLoggedIn) {
                const userCart = await userCartService.viewCart(userId);
    ...
    const handleIncreaseQuantity = async (productId)=>{
        if (isLoggedIn) {
            await userCartService.updateCartCount(userId, productId, 'increase');
            const userCart = await userCartService.viewCart(userId);
            setProducts(userCart);
        } else {
    ...
    const handleDecreaseQuantity = async (productId)=>{
        if (isLoggedIn) {
            await userCartService.updateCartCount(userId, productId, 'decrease');
            const userCart = await userCartService.viewCart(userId);
            setProducts(userCart);
        } else {
    ...
    const handleRemoveProduct = async (productId)=>{
        if (isLoggedIn) {
            await userCartService.deleteFromCart(userId, productId);
            const userCart = await userCartService.viewCart(userId);
            setProducts(userCart);
        } else {
    ...
    const calculateTotalPrice = ()=>{
        return products.reduce((total, product)=>total + product.offerPrice * product.quantity, 0).toFixed(2);
    };
...
function CartTile({ product, index, onIncreaseQuantity, onDecreaseQuantity, onRemoveProduct }) {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mx-auto flex h-8 items-stretch text-gray-600",
                                            children: [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d130e7._.js.map