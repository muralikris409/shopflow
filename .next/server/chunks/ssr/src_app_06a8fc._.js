...
async function updateProfileInfo(token, userId, data) {
    try {
        console.log("test");
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post(`user/updateUserProfile?userId=${userId}
        &data=${data}`, {}, {
            headers: {
                Authorization: `Bearer ${token}`
            }
...
//# sourceMappingURL=src_app_06a8fc._.js.map