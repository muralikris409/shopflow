...
async function Deals({ fetchData, title }) {
  ...
  return (
    ...
    <section className="mt-5 flex justify-center w-2/4 py-10">
      <div className="w-full max-w-screen-md px-4 py-8">
        <h1 className="text-center text-2xl font-semibold text-gray-800 md:text-3xl">
          {title}
        </h1>
